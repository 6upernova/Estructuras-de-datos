...
import Excepciones.*;
import Punto4.ArrayQueue;
import Punto4.EmptyQueueException;
...
public class TreeTest {
	...
	public void addBefore() {
		...
		try {
			...
			hijosH1 = new ListDE<Integer>();
			hijosH1.addFirst(4);
			hijosH1.addFirst(5);
			hjsH1 = new ListDE<Integer>();
	...
	public void addAfter() {
		...
		try {
			...
			chequearPadre(T.root());
			// caso de prueba para los hijos de root
			PositionList<Integer> hijosRoot = new ListDE<Integer>();
			hijosRoot.addFirst(2);
			hijosRoot.addFirst(7);
			hijosRoot.addFirst(3);
			hijosRoot.addFirst(6);
			hijosRoot.addFirst(9);
			PositionList<Integer> hijos = new ListDE<Integer>();
			for (Position<Integer> n : T.children(T.root())) {
	...
	public void remove() {
		...
		T = getTree();
		cargarArbol2(T);
		lista = new ListDE<Position<Integer>>();
		try {
